...
# students_take_courses_python = cursor.execute('''SELECT
#                                     Students.name
#                                 FROM
#                                     Students, Courses, Student_courses
#                                 WHERE
#                                     course_id = 1''').fetchall()
# students_take_courses_python_and_SPB = cursor.execute('''SELECT
#                                     Students.name
#                                 FROM
#                                     Students, Courses, Student_courses
#                                 WHERE
#                                     course_id = 1 and Students.city = "Spb"''').fetchall()
#
# print(age_more_30)
# print(students_take_courses_python)  # здесь выводится пустой список
# print(students_take_courses_python_and_SPB) # и здесь выводится пустой список
# conn.commit()
#
# conn.close()
